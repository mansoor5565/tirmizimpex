                            ...
                            <div class="col-12">
                                ...
                                <select class="form-select mb-2" id="selectLeathers" name="leathers[]" multiple>
                                    @foreach ($leathercolor as $leathercolors)
                                        <option value="{{ $leathercolors->id }}"{{ $leather_inventory->where('leathercolor_id', $leathercolors->id) ? 'selected' : '' }}>{{ $leathercolors->leathers->type ." ". $leathercolors->color }}</option>
                                    @endforeach
                                </select>
