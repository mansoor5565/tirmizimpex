                                ...
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="option5" name="option[]"
                                                value="2XL"
                                                {{ $productsize->contains('size', '2XL') ? 'checked' : '' }}>
                                    ...
                                    <div class="col-auto">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="option6"
                                                ...
                                                {{ $productsize->contains('size', '3XL') ? 'checked' : '' }}>
                                    ...
                                    <div class="col-auto">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="option7"
                                                ...
                                                {{ $productsize->contains('size', '28') ? 'checked' : '' }}>
                                    ...
                                    <div class="col-auto">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="option8"
                                                ...
                                                {{ $productsize->contains('size', '30') ? 'checked' : '' }}>
                                    ...
                                    <div class="col-auto">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="option9"
                                                ...
                                                {{ $productsize->contains('size', '32') ? 'checked' : '' }}>
                                    ...
                                    <div class="col-auto">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="option10"
                                                ...
                                                {{ $productsize->contains('size', '34') ? 'checked' : '' }}>
                                    ...
                                    <div class="col-auto">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="option11"
                                                ...
                                                {{ $productsize->contains('size', '36') ? 'checked' : '' }}>
                                    ...
                                    <div class="col-auto">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="option12"
                                                ...
                                                {{ $productsize->contains('size', '38') ? 'checked' : '' }}>
                                    ...
                                    <div class="col-auto">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="option13"
                                                ...
                                                {{ $productsize->contains('size', '40') ? 'checked' : '' }}>
                                    ...
                                    <div class="col-auto">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="option14"
                                                ...
                                                {{ $productsize->contains('size', '42') ? 'checked' : '' }}>
                                    ...
                                    <div class="col-auto">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="option15"
                                                ...
                                                {{ $productsize->contains('size', '44') ? 'checked' : '' }}>
                                    ...
                                    <div class="col-auto">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="option5"
                                                ...
                                                {{ $productsize->contains('size', 'Custom') ? 'checked' : '' }}>
                            ...
                            <select class="form-select mb-2" id="leatherSelect" name="leather">
                                ...
                                @foreach ($leathers_color as $leather_color)
                                    <option value="{{ $leather_color->id }}"
                                        {{ $product_leather->contains('productcolor_id', $leather_color->id) ? 'selected' : '' }}>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                @error('images')
                                @enderror
                                @include('components.multiple-image-picker-edit')
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <select class="form-select" id="selectAccessories" name="accessories[]" multiple>
                                    @foreach ($accessories as $accessory)
                                        <option value="{{ $accessory->id }}"
                                            {{ $productaccessories->contains('accessories_id', $accessory->id) ? 'selected' : '' }}>
                                            {{ $accessory->name }}
                                        </option>
                                    @endforeach
                                </select>
